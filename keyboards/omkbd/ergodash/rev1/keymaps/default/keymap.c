...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+ ENT  +------+------+------+ ENT  +------+------+------+------+-------------|
   * |NUMPAD|      |      |SYMBOL|||||||| BSpc | Cmd  | Ctrl |||||||| Ctrl | Cmd  | SPACE||||||||SYMBOL|      |      |      |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT(
    ...
    NUMPAD,    XXXXXXX, XXXXXXX, SYMBOLS,       KC_BSPC, LCMD_ENT, KC_LCTL,  KC_RCTL, RCMD_ENT, KC_SPC,       SYMBOLS, XXXXXXX, XXXXXXX, XXXXXXX
  ),
   ...
   * |      |      |      |      |      |      |      |       ||||||||       |      |  *   |  1   |  2   |  3   |      |      |
   * |-------------+------+------+------+------+Enter +-------||||||||------+Enter +------+------+------+------+-------------|
   * |NUMPAD|      |      |SYMBOL|||||||| BSpc | Cmd  | Ctrl |||||||| Ctrl | Cmd  |   0  ||||||||   .  |      |      |      |
   * ,------------------------------------------------------------------------------------------------------------------------.
   */
  [_NUMPAD] = LAYOUT(
