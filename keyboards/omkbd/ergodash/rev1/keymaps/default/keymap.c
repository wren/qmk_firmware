...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+ ENT  +------+------+------+ ENT  +------+------+------+------+-------------|
   * |NUMPAD|      |SYMBOL| Ctrl |||||||| BSpc | Cmd  | Cmd  |||||||| Cmd  | Cmd  | SPACE|||||||| Ctrl | Alt  |SYMBOL|      |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT(
    ...
    NUMPAD,    XXXXXXX, SYMBOLS, KC_LCTL,       KC_BSPC, LCMD_ENT, KC_RGUI,  KC_LGUI, RCMD_ENT, KC_SPC,       KC_RCTL, SYMBOLS, KC_LALT, XXXXXXX
  ),
   ...
   * | Shift|      |      |      |      |      | Meh  |       ||||||||       | Meh  |      |      |   <  |   >  |   ?  | Shift|
   * |-------------+------+------+------+------+------+ Enter |||||||| Enter +------+------+------+------+------+-------------|
   * |SYMBOL|NUMPAD|  Alt | Ctrl |||||||| Del  | Cmd  |       ||||||||       | Cmd  | Space|||||||| Ctrl | Alt  |NUMPAD|SYMBOL|
   * ,------------------------------------------------------------------------------------------------------------------------.
   */
  [_SYMBOLS] = LAYOUT(
   ...
   * |      |      |      |      |      |      | Alt  |       ||||||||       | Alt  |  *   |  1   |  2   |  3   |      |      |
   * |-------------+------+------+------+------+------+ Enter |||||||| Enter +------+------+------+------+------+-------------|
   * |SYMBOL|NUMPAD|  Alt | Ctrl |||||||| Space| Cmd  |       ||||||||       | Space|  0   ||||||||  .   |  .   |      |      |
   * ,------------------------------------------------------------------------------------------------------------------------.
   */
  [_NUMPAD] = LAYOUT(
    ...
    _______, _______, _______, _______,          KC_SPC , _______,  _______,   _______,  KC_SPC , KC_P0  ,          KC_PDOT, KC_PDOT, XXXXXXX, XXXXXXX
  )
};
